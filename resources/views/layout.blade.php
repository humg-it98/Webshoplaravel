...
<head>
	...
	<!-- Title Tag  -->
    <title>Eshop - Shop bán hàng trực tuyến.</title>
	<!-- Favicon -->
	...
	<!-- Color CSS -->
	<link rel="stylesheet" href={{asset("public/frontend/css/color/color1.css")}}>
	<link rel="stylesheet" href={{asset("public/frontend/css/color/color2.css")}}>
...
<body class="js">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-12 col-12">
						...
						<div class="top-left">
							<ul class="list-main">
								<li><i class="ti-headphone-alt"></i> 0372105792</li>
								...
								<div class="shopping-item">
									...
									<ul class="shopping-list">
										<li>
											...
											<a class="cart-img" href="#"><img src="public/frontend/images/product-1.jpg" alt="#"></a>
											<h4><a href="#">Woman Ring</a></h4>
											<p class="quantity">1x - <span class="amount">$99.00</span></p>
										</li>
										<li>
											<a href="#" class="remove" title="Remove this item"><i class="fa fa-remove"></i></a>
											<a class="cart-img" href="#"><img src="public/frontend/images/product-2.jpg" alt="#"></a>
									...
									<li class="main-mega"><a href="#">best selling <i class="fa fa-angle-right" aria-hidden="true"></i></a>
										<ul class="mega-menu">
											<li class="single-menu">
												...
												<div class="image">
													<img src="public/frontend/images/mega-menu1.jpg" alt="#">
												</div>
											...
											<li class="single-menu">
												...
												<div class="image">
													<img src="public/frontend/images/mega-menu2.jpg" alt="#">
												</div>
												<div class="inner-link">
													<a href="#">Watch</a>
													<a href="#">T-shirt</a>
											...
											<li class="single-menu">
												...
												<div class="image">
													<img src="public/frontend/images/mega-menu3.jpg" alt="#">
												</div>
												<div class="inner-link">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="single-banner">
						<img src="public/frontend/images/mini-banner1.jpg" alt="#">
						<div class="content">
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="single-banner">
						<img src="public/frontend/images/mini-banner2.jpg" alt="#">
						<div class="content">
							<p>Bag Collectons</p>
				...
				<div class="col-lg-4 col-12">
					<div class="single-banner tab-height">
						<img src="public/frontend/images/mini-banner3.jpg" alt="#">
						<div class="content">
							<p>Flash Sale</p>
                                ...
                                <!-- Product Slider -->
									<div class="product-gallery">
										<div class="quickview-slider-active">
											<div class="single-slider">
												<img src="public/frontend/images/modal1.png" alt="#">
											</div>
											<div class="single-slider">
												<img src="public/frontend/images/modal2.png" alt="#">
											</div>
											<div class="single-slider">
												<img src="public/frontend/images/modal3.png" alt="#">
											</div>
											<div class="single-slider">
												<img src="public/frontend/images/modal4.png" alt="#">
											</div>
										</div>
									</div>
								<!-- End Product slider -->
				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							<div class="logo">
								<a href="index.html"><img src="public/frontend/images/logo2.png" alt="#"></a>
							</div>
			...
			<div class="container">
				<div class="inner">
					<div class="row">
						...
						<div class="col-lg-6 col-12">
							<div class="right">
								<img src="public/frontend/images/payments.png" alt="#">
							</div>
						</div>
					</div>
				</div>
	...
	<!-- Fancybox JS -->
	<script src="public/frontend/js/facnybox.min.js"></script>
	<!-- Waypoints JS -->
	...
	<!-- Ytplayer JS -->
	<script src="public/frontend/js/ytplayer.min.js"></script>
	<!-- Flex Slider JS -->
